...
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Mr.DinXploit.flf ]; then
	echo -e "\e[1;34m[*] \033[32mMr.DinXploit.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/remo7777/REMO773/master/Remo773.flf &> /dev/null;
sleep 3
cat DinXploit.flf >> $PREFIX/share/figlet/DinXploit.flf
sleep 3
rm DinXploit.fif
fi
THEADER () 
...
clear;
echo -e "\033[31m$(figlet -f Remo773 "MR.DINXPLOIT")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
Mr.DinXploit404 : (\e[33m12.7.2018\e[32m)
